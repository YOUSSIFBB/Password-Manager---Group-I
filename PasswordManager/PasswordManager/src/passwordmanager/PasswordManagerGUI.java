...
//    public int nextId = 0;
//    public int id =0;
//    ArrayList<PasswordManager> personList = new ArrayList<>();
    ...
    private void initComponents() {
        ...
        MainPasswordManagerPanel.add(EncryptPasswordLbl1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 300, -1, 40));
        ...
        MainPasswordManagerPanel.add(EncryptPasswordDisplay1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 300, 390, 34));

        GeneratePasswordBtn1.setFont(new java.awt.Font("Bookman Old Style", 1, 36)); // NOI18N
        GeneratePasswordBtn1.setText("Generate-Password");
        GeneratePasswordBtn1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                GeneratePasswordBtn1ActionPerformed(evt);
            }
        });
        MainPasswordManagerPanel.add(GeneratePasswordBtn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 360, -1, -1));
        ...
        MainPasswordManagerPanel.add(DeleteAccountBtn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 360, 380, -1));
        ...
        MainPasswordManagerPanel.add(SignOutBtn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 430, 380, 60));
...
//        private String name, emailAddress, password, dateOfBirth, sex;
...
//        int id = 0;
    ...
    private void LoginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginBtnActionPerformed
        ...
        try {
            // Read the file to check if the email and password exist
            BufferedReader br = new BufferedReader(new FileReader("UserInformation.txt"));
            String line;
            while ((line = br.readLine()) != null) {
                // Assuming the format is: firstName, lastName, emailAddress, phoneNumber, password, dateOfBirth, sex
                String[] userDetails = line.split(", ");
                if (userDetails.length >= 9) {
                    String email = userDetails[2];
                    //String password = userDetails[4];
                    String storedSalt = userDetails[8]; //specefied index for sored salt value 
                    String storedHash = userDetails[7]; //specefied index for sored hash password
        ...
        if (response == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                if (accountFound) {
                    ...
                    // Additional code for after account deletion
                }
